...
// click | id=candidates_description | 
$driver->findElement(WebDriverBy::id("candidates_description"))->click();
// type | id=candidates_description | Anexion
$driver->findElement(WebDriverBy::id("candidates_description"))->sendKeys("Anexion");
// click | xpath=(.//*[normalize-space(text()) and normalize-space(.)='Add Candidates'])[1]/following::ol[1] | 
$driver->findElement(WebDriverBy::xpath("(.//*[normalize-space(text()) and normalize-space(.)='Add Candidates'])[1]/following::ol[1]"))->click();
...
// click | id=candidates_recurring | 
$driver->findElement(WebDriverBy::id("candidates_recurring"))->click();
// click | id=candidates_length | 
$driver->findElement(WebDriverBy::id("candidates_length"))->click();
// click | id=saveBtn | 
...
// click | id=candidates_description | 
$driver->findElement(WebDriverBy::id("candidates_description"))->click();
// type | id=candidates_description | Anexion Guanacaste
$driver->findElement(WebDriverBy::id("candidates_description"))->clear();
$driver->findElement(WebDriverBy::id("candidates_description"))->sendKeys("Anexion Guanacaste");
// click | id=saveBtn | 
$driver->findElement(WebDriverBy::id("saveBtn"))->click();
...
$caps = array(
    array(
        ...
        "build" => "Testreclutamiento Build",
        "name" => "Test reclutamiento"
    )
  );
foreach ( $caps as $cap ) {
    executeTestCase($cap);
